# Activation protocol — mac-cleaner
...
**Generated by `ab init` on 2026-04-29.** After activation, this file stays in place so you can re-activate or re-run parts of the protocol later, but the root `CLAUDE.md` becomes the steady-state entry point.
...
**`.platform/memory/log.md`** — append one line: `2026-04-29 — ab activation — .platform/ pack filled from scan + interview — <one-sentence summary of what you learned>`
...
3. Write the new file as: `<!-- agentboard:root-entry:begin v=1 -->\n<your ab section>\n<!-- agentboard:root-entry:end v=1 -->\n\n---\n\n## Existing CLAUDE.md content (preserved by ab activation on 2026-04-29)\n\n` + `<original content>`.
