...
- `menubar.py` renders the macOS menu bar free/available RAM widget, dropdown memory stats, top process list, and RAM purge action.
...
- Menu bar process visibility is read-only; do not add process kill/quit actions there without explicit confirmation design.
